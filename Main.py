...
class Ui_Main(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(815, 585)
        Dialog.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(10, 10, 821, 111))
        self.label.setStyleSheet("font: 75 18pt \"Tahoma\";\n"
"font: 20pt \"Franklin Gothic Demi\";")
        self.label.setObjectName("label")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(20, 160, 351, 341))
        self.label_3.setStyleSheet("image: url(../Detection/fic.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Fingerprint Image Identification for Crime Detection"))
